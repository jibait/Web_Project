 ...
 */
final class Version20230620105956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, product_title VARCHAR(255) NOT NULL, product_description VARCHAR(255) DEFAULT NULL, price INT NOT NULL, product_img VARCHAR(255) NOT NULL, product_rate VARCHAR(255) DEFAULT NULL, product_tag VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
